...
public class StringUtilsTest {
    ...
    @Test
    public void should_return_first_half_woo_of_string() {
        assertEquals("Woo", StringUtils.firstHalf("WooHoo"));
    }
    
    @Test
    public void should_return_first_half_hello_of_string() {
        assertEquals("Hello", StringUtils.firstHalf("HelloThere"));
    }
    
    @Test
    public void should_return_first_half_abc_of_string() {
        assertEquals("abc", StringUtils.firstHalf("abcdef"));
    }
}
